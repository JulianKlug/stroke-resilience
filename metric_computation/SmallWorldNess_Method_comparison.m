...
'normalized_mean_path_length', 'normalized_mean_clustering_coefficient', ...
'random_graph_path_length', 'random_graph_clustering_coefficient'};
results = {
                'analytical approximation','WS clustering coefficient', ...
                L_ws,C_ws,S_ws, Ls_ws, Cs_ws, expectedL, expectedC;
                'analytical approximation','transitive clustering coefficient', ...
                L_trans,C_trans,S_trans, Ls_trans, Cs_trans, expectedL, expectedC;
                'Monte Carlo estimate of random graph','WS clustering coefficient', ...
                L_ws_MC,C_ws_MC,S_ws_MC, Ls_ws_MC, Cs_ws_MC, Lrand,CrandWS;
                'Monte Carlo estimate of random graph','transitive clustering coefficient', ...
                L_trans_MC,C_trans_MC,S_trans_MC, Ls_trans_MC, Cs_trans_MC, Lrand,CrandTrans;
                };
