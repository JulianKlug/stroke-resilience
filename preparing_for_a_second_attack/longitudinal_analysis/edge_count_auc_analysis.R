...
df_path = '/Users/jk1/temp/stroke_resilience/output/analysis/edge_count_auc_with_initial_lesion_char.csv'
...
edge_count_model_fit <- lmer(edge_count_auc ~ timepoint + lesion_volume + lesion_side + (1|subject), df_st)
