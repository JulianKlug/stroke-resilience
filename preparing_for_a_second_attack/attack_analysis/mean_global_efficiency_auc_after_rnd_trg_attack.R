...
# lesion side and lesion volume were added as fixed effects post-hoc
...
random_attack_timepoint_model_fit_corrected <- lmer(mean_glob_eff_auc ~ timepoint + lesion_volume + lesion_side+ (1|subject), df_random_st)
...
targeted_attack_timepoint_model_fit_corrected <- lmer(mean_glob_eff_auc ~ timepoint + lesion_volume + lesion_side + (1|subject), df_targeted_st)
