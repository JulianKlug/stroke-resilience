...
fpath = '/Users/jk1/stroke_research/resilience_stroke/attack_analysis/figures/targeted_attack';
nroi = 240;
npatients = 15;
nhc = 16;
%
...
title('Targeted attack','FontWeight','bold')
% plotname = ['FDA_GlobEff_degrees_AUC_TP1'];
plotname = ['FDA_GlobEff_trg_degrees_AUC_TP1'];
set(gca,'FontSize',13)
saveas(gcf,plotname)
...
plotname = ['FDA_GlobEff_trg_degrees_AUC_TP2'];
set(gca,'FontSize',13)
saveas(gcf,plotname)
print(gcf, '-dtiff', [plotname '.tiff']);
...
plotname = ['FDA_GlobEff_trg_degrees_AUC_TP3'];
set(gca,'FontSize',13)
saveas(gcf,plotname)
print(gcf, '-dtiff', [plotname '.tiff']);
