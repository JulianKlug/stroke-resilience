...
df_full <- read_csv("/Users/jk1/stroke_research/resilience_stroke/attack_analysis/glob_eff_auc_after_attack_df_with_patient_characteristics.csv")
# df_full$timepoint = as.factor(df_full$timepoint) # converting to categorical
df_full$attack_location = as.factor(df_full$attack_location) # converting to categorical
...
# timepoint_model_fit <- lmer(glob_eff_auc ~  attack_location*timepoint + (1|subject), df_st)
timepoint_model_fit_corrected <- lmer(glob_eff_auc ~  attack_location*timepoint + (1|lesion_volume) + (1|subject) + (1|lesion_side), df_st)
timepoint_model_fit <- timepoint_model_fit_corrected
anova(timepoint_model_fit)
...
group_model_fit <- lmer(glob_eff_auc ~ time_group * attack_location + (1|subject), df_full)
