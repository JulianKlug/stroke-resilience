...
df_full <- read_csv("/Users/jk1/stroke_research/resilience_stroke/attack_analysis/glob_eff_auc_after_attack_df.csv")
...
timepoint_model_fit <- lmer(glob_eff_auc ~ timepoint * attack_location + (1|subject), df_st)
