...
def filter_small_regions(data_directory:str, atlased_T1_name_end: str = '_AtlasBN_Atlas_246.nii',
                         masked_connectivity_matrix_name:str = 'masked_transfer_exclude0_corrCMs_useAtlas1BN_Atlas_246_subband4_blockDriftCorrlinear_firstEV0_windsor1_95_regressOutMotion1_regressOutCSF1_regOutMat0_ROImeanScaling1_removeFirstNscans5_BootNone.mat',
    ...
    Arguments:
        ...
        masked_connectivity_matrix_name {str} -- name of masked connectivity matrix file (default: {'masked_transfer_exclude0_corrCMs_useAtlas1BN_Atlas_246_subband4_blockDriftCorrlinear_firstEV0_windsor1_95_regressOutMotion1_regressOutCSF1_regOutMat0_ROImeanScaling1_removeFirstNscans5_BootNone.mat'})
    ...
    for connectivity_file in connectivity_files_paths:
        remove_regions_from_masked_connectivity_file(small_regions, connectivity_file, save_prefix=save_prefix,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--connectivity_name', '-c', required=False, type=str, help='name of the masked connectivity file',
                        default='masked_transfer_exclude0_corrCMs_useAtlas1BN_Atlas_246_subband4_blockDriftCorrlinear_firstEV0_windsor1_95_regressOutMotion1_regressOutCSF1_regOutMat0_ROImeanScaling1_removeFirstNscans5_BootNone.mat')
    ...
    filter_small_regions(args.data_directory, atlased_T1_name_end=args.atlased_T1_name_end,
                         masked_connectivity_matrix_name = args.connectivity_name,
