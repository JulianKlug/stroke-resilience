...
tp0_model_fit <- lmer(loc_eff_auc ~ group + (1|subject) + (1|roi), tp0_df)
...
# get parameter estimates from a linear regression with random effects
tp1_model_fit <- lmer(loc_eff_auc ~ group + (1|subject) + (1|roi), tp1_df)
...
# get parameter estimates from a linear regression with random effects
tp2_model_fit <- lmer(loc_eff_auc ~ group + (1|subject) + (1|roi), tp2_df)
